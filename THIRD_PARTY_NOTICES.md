...
The included `assets/accretion_disk.png` is derived from the Starless asset and
has been modified. It remains covered by GPLv3.
...
- License: MIT
- Installed as an npm dependency. This project uses `lil-gui`, not the older
  `dat.GUI` package mentioned by the source project.
...
The following files are generated from original project scripts and are not
copied from the former non-commercial Milky Way asset:

- `assets/milkyway-preview.jpg`
